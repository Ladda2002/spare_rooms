...
<body>
  ...
  <main class="" id="main-collapse">
    ...
    <div class="row">
      ...
      <?php if(empty($allContract)){ ?>
      <?php }else{?>
        <?php $i=1;?>
        <?php foreach($allContract as $data){ ?>
          <div class="col-xs-12 col-md-4 section-container-spacer">
            ...
            <a href="detail_contract.php?id=<?php echo $data['id'];?>" class="btn btn-primary" title=""> รายละเอียด</a>
          </div>
